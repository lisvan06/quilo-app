          ...
          <tr key={element.id}>
            ...
            <td className="px-5 py-2 border-b border-gray-200 bg-white text-center text-sm">
              {element.published ? (
                ...
                // </span>
                <BtnPublish id={element.id} route={"products"} status={true}/>
              ) : (
                ...
                // </span>
                <BtnPublish product={element} route={"products"} status={false}/>
              )}
            </td>
            <td className="px-5 py-2 border-b border-gray-200 bg-white text-sm text-center">
              <BtnEdit id={element.id} route={"products"} />
            </td>
            <td className="px-5 pb-2 border-b border-gray-200 bg-white text-sm text-center">
